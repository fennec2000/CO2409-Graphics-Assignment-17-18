...
VS_NORMALMAP_OUTPUT NormalMapWobbleTransform(VS_NORMALMAP_INPUT vIn)
{
	VS_NORMALMAP_OUTPUT vOut;
...
technique10 ParallaxMappingWobble
{
	pass P0
	{
		SetVertexShader(CompileShader(vs_4_0, NormalMapWobbleTransform()));
		SetGeometryShader(NULL);
		SetPixelShader(CompileShader(ps_4_0, NormalMapLighting()));
